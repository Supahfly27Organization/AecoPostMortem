...
Created 2026-08-16 in [`Supahfly27Organization/AecoPostMortem`](https://github.com/Supahfly27Organization/AecoPostMortem)
and tracked on [project board #7](https://github.com/orgs/Supahfly27Organization/projects/7). Epic E6 is gated out of v1 and was deliberately not synced.

- Epic: [E1 — Durable ingestion](https://github.com/Supahfly27Organization/AecoPostMortem/issues/1)
  - Story: [S-01 — Local store and its governance (FR-11, FR-2)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/2)
  - Story: [S-02 — Session discovery and event-line parsing (FR-1, FR-3, FR-6)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/3)
  - Story: [S-03 — Polymorphic tool arguments (FR-4)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/4)
  - Story: [S-04 — Idempotent, append-safe re-ingest (FR-5)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/5)
  - Story: [S-05 — Self-exclusion and the coverage report (FR-7, FR-14)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/6)
  - Story: [S-06 — Execution record reconstruction (FR-8, FR-9)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/7)
  - Story: [S-07 — Volume control and the sources deliberately not read (FR-10, FR-12, FR-13)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/8)
  - Story: [S-45 — Phase A verification: census, replay and scale (PRD §3.5, §3.7)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/9)
  - Story: [S-47 — Solution scaffold and the command surface (FR-58, PRD §3.1)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/10)
  - Story: [S-48 — API host, web shell and the zero-data state (PRD §3.1)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/11)
  - Story: [S-49 — Execution-record entity contract (PRD §3.2)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/12)
  - Story: [S-50 — API response envelope (FR-59)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/13)
- Epic: [E2 — One session, readable](https://github.com/Supahfly27Organization/AecoPostMortem/issues/14)
  - Story: [S-08 — Flight Recorder: masthead and tape (FR-21, part 1 of 3)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/15)
  - Story: [S-52 — Flight Recorder: inspector, tabs and finding chips (FR-21, part 2 of 3)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/16)
  - Story: [S-53 — Flight Recorder: scale, keyboard and the non-happy states (FR-21, part 3 of 3)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/17)
  - Story: [S-09 — Subagent lanes and their real output (FR-22)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/18)
  - Story: [S-10 — The Thinking lane, and why it is empty (FR-23)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/19)
  - Story: [S-11 — Session token figures, without inventing a price (FR-24)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/20)
  - Story: [S-12 — Skills as first-class steps (FR-25)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/21)
- Epic: [E3 — Waste, with denominators](https://github.com/Supahfly27Organization/AecoPostMortem/issues/22)
  - Story: [S-44 — The findings contract and the check registry (PRD §3.2, §3.8)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/23)
  - Story: [S-46 — Rebuildability and determinism (PRD §3.2, §3.8)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/24)
  - Story: [S-13 — Repeated file reads (FR-15)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/25)
  - Story: [S-14 — Failed tool calls (FR-16)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/26)
  - Story: [S-15 — Hook failures, with both denominators (FR-17)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/27)
  - Story: [S-16 — Aborted turns (FR-18)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/28)
  - Story: [S-17 — Phase churn (FR-19)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/29)
  - Story: [S-18 — Interruption load (FR-20)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/30)
- Epic: [E4 — The rules the agent was given](https://github.com/Supahfly27Organization/AecoPostMortem/issues/31)
  - Story: [S-19 — Rule extraction from the system prompt (FR-26)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/32)
  - Story: [S-20 — Rule-set versioning (FR-27, FR-28)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/33)
  - Story: [S-21 — Tool vocabulary and derived roles (FR-29, FR-30)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/34)
  - Story: [S-22 — The Rules Inventory (FR-40)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/35)
- Epic: [E5 — Adherence you can check](https://github.com/Supahfly27Organization/AecoPostMortem/issues/36)
  - Story: [S-23 — Four-layer operand resolution (FR-31, FR-32)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/37)
  - Story: [S-24 — Every figure ships with its resolution (FR-33)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/38)
  - Story: [S-25 — The check-shape catalogue names nothing (FR-34)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/39)
  - Story: [S-26 — "This rule names a tool your agent does not have" (FR-35)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/40)
  - Story: [S-27 — Conditional rules report base rates, labelled (FR-44)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/41)
- Epic: [E7 — The loop closes](https://github.com/Supahfly27Organization/AecoPostMortem/issues/42)
  - Story: [S-35 — The Monitor comparison (FR-39)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/43)
  - Story: [S-36 — The Process Digest: ranking and masthead (FR-41, part 1 of 2)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/44)
  - Story: [S-54 — The Process Digest: row expansion, recurrence and repository scope (FR-41, part 2 of 2)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/45)
  - Story: [S-37 — Checks that found nothing (FR-42)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/46)
  - Story: [S-38 — The contradiction check, shipped as Inferred (FR-43)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/47)
  - Story: [S-51 — Suggestions, as deterministic templates (FR-56)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/48)
  - Story: [S-39 — Recording what the operator does with a suggestion (FR-45)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/49)
- Epic: [E8 — Missing capability](https://github.com/Supahfly27Organization/AecoPostMortem/issues/50)
  - Story: [S-40 — Tool-failure clusters (FR-46)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/51)
  - Story: [S-42 — Inferred findings are visibly separate (FR-48)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/52)
  - Story: [S-43 — Subagent rule attribution, or nothing (FR-49)](https://github.com/Supahfly27Organization/AecoPostMortem/issues/53)
