...
`SystemPromptExtractor`, `RewindSnapshotSource`) and the polymorphic `arguments` parser
(`ToolArguments`) exist as composable building blocks (FR-1, FR-3, FR-4, FR-5, FR-6, FR-10, FR-12,
FR-13). `ToolArguments` is not yet wired into
