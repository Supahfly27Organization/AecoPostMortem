...
| 9 | **Methodology footer — Digest** (Digest) | **5** — mostly static content, no new data beyond what's already computed (corpus scope, ingest timestamp) | **4 (XS–S)** — write the copy, one new footer component | **1 Could** — transparency polish, not core | **10** | Open |
